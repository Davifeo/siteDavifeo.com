jQuery(function ($) {
	var optionTypeClass = '.fw-option-type-ckav-icon';
	...
	fwEvents.on('fw:options:init', function (data) {
		...
		$options.find(".fw-icon-search").on("keyup", function() {
			var value = $(this).val().toLowerCase();
			$options.find(".js-option-type-icon-list .js-option-type-icon-item").filter(function() {
				$(this).toggle($(this).attr('data-value').indexOf(value) > -1);
			});
		});
