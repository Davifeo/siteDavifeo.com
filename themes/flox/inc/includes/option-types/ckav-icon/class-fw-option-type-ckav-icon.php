...
class FW_Option_Type_CkavIcon extends FW_Option_Type
{
	/**
	...
	protected function _enqueue_static($id, $option, $data)
	{
		wp_enqueue_style(
			...
			THEME_URI . '/inc/includes/option-types/'. $this->get_type() .'/static/css/backend.css',
			fw()->manifest->get_version()
		);

		wp_enqueue_script(
			'fw-option-type-'. $this->get_type() .'-backend',
			THEME_URI . '/inc/includes/option-types/'. $this->get_type() .'/static/js/backend.js',
	...
	private function generate_unknown_set($icon)
	{
		return array(
			...
			'container-class' => '',
			'groups' => array(
				'unknown' => esc_html__('Unknown Set', 'flox'),
			),
			'icons' => array(
	...
	private function get_default_sets()
	{
		...
		//     groups => array(
		//         array(
		//             'title' => esc_html__('Web Application Icons', 'flox')
		//             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
		//         ),
		//         array(
		//             'title' => esc_html__('Transportation Icons', 'flox'),
		//             'icons' => array(...),
		//         ),
		//     )
		//
		...
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups' => array (
					'web-application' => esc_html__('Web Application Icons', 'flox'),
					'hand' => esc_html__('Hand Icons', 'flox'),
					'transportation' => esc_html__('Transportation Icons', 'flox'),
					'gender' => esc_html__('Gender Icons', 'flox'),
					'file-type' => esc_html__('File Type Icons', 'flox'),
					'payment' => esc_html__('Payment Icons', 'flox'),
					'currency' => esc_html__('Currency Icons', 'flox'),
					'text-editor' => esc_html__('Text Editor Icons', 'flox'),
					'directional' => esc_html__('Directional Icons', 'flox'),
					'video-player' => esc_html__('Video Player Icons', 'flox'),
					'brand' => esc_html__('Brand Icons', 'flox'),
					'medical' => esc_html__('Medical Icons', 'flox'),
				),
				'icons' => array(
...
FW_Option_Type::register('FW_Option_Type_CkavIcon');