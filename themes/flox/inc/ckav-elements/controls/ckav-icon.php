 ...
 * @since 1.0.0
 */
class Ckav_Icon_Ctrl extends Elementor\Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-field">
			...
			<div class="elementor-control-input-wrapper">
				<select id="<?php echo esc_attr($control_uid); ?>" class="elementor-control-icon" data-setting="{{ data.name }}" data-placeholder="<?php echo esc_html__( 'Select Icon', 'flox' ); ?>">
					<option value=""><?php echo esc_html__( 'Select Icon', 'flox' ); ?></option>
