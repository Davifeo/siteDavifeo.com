	...
	<div class="carousel-widget ctrl-1 <?php echo esc_attr($light_ctrl); ?>" 
		...
		<div class="owl-carousel">
			...
			<div class="item">
                ...
                <div class="testimonial-wrp style-3 <?php echo esc_attr($light_theme); ?>">
                    <div class="row">
                        <div class="col-md-auto">
                            <span class="sq140 iconbox img bg-cc bg-cover" style="background-image: url(<?php echo esc_url($p_img); ?>);"></span>
                        </div>
                        <div class="col-md">
                            <div class="desc">
                                <?php echo ckav_esc( $testimonial['desc'] ); ?>
                            </div>
                            <h3 class="content-title small"><?php echo esc_html($testimonial['title']); ?></h3>
